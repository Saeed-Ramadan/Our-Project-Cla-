const phoneProduct = document.getElementById("phone-product");
  ...
  .then((products) => {
    ...
    products.products.forEach((pro) => {
      for (var i = 0; i <= products.products.length; i++) {
        ...
        phoneProduct.innerHTML += `<div  class="one" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
